      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24">
        ...
        >
          <a
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-3 bg-alpha-red hover:bg-alpha-red-dark text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 hover:shadow-xl hover:shadow-alpha-red/25 hover:-translate-y-0.5"
          >
          ...
          <a
            href="#servicos"
            className="w-full sm:w-auto text-gray-light hover:text-white-soft transition-colors text-sm font-medium underline underline-offset-4 decoration-gray-light/30 hover:decoration-white-soft/50"
          >
